...
jobs:
  pr-check-job:
    ...
    - name: Notify job run
      run: |
        echo "PR job running for: ${{ github.ref_name }}"

```

<img width="1340" height="679" alt="image" src="https://github.com/user-attachments/assets/d77eb95f-91f3-4d11-814b-760d58b49f07" />

<img width="1416" height="634" alt="image" src="https://github.com/user-attachments/assets/f7a4f239-dcd3-4375-9368-337150906937" />
