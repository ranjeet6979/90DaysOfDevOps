...
4. What happens to your files when you switch branches?
   ...
   Working directory updates to match the state of the selected branch. Files may change, appear, or disappear based on that branch’s commits.
...
3. Switch to `feature-1`
   ...
   <img width="541" height="331" alt="image" src="https://github.com/user-attachments/assets/cb05debc-bfb5-4145-b429-f5f8de6c4367" />

4. Create a new branch and switch to it in a single command — call it `feature-2`

  <img width="544" height="136" alt="image" src="https://github.com/user-attachments/assets/eab2a651-1002-4533-85d4-7b1561a22ef4" />
...
8. Make a commit on `feature-1` that does **not** exist on `main`
9. Switch back to `main` — verify that the commit from `feature-1` is not there
10. Delete a branch you no longer need
